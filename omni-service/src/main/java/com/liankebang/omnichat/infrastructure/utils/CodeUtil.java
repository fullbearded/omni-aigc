package com.liankebang.omnichat.infrastructure.utils;
...
public class CodeUtil {
	...
	public static String generateNewCode(String prefix, int codeLen) {
		String nonNullPrefix = Strings.nullToEmpty(prefix);
		int remainingCodeLen = codeLen - nonNullPrefix.length();
		return nonNullPrefix + generateNewCode(remainingCodeLen, 0, 0, 7);
	}
